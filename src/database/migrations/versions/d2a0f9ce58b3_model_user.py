...
Revision ID: d2a0f9ce58b3
Revises: 3ca2de04584a
Create Date: 2025-10-13 18:43:59.321499
...
revision: str = 'd2a0f9ce58b3'
down_revision: Union[str, Sequence[str], None] = '3ca2de04584a'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'year', 'time', name='unique_movie_name_year_time'),
